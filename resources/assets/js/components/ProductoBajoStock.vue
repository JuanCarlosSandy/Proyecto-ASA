            ...
            <table class="table table-bordered table-striped table-sm">
                <thead>
                    <tr class="table-info"> <!-- Agrega la clase "table-info" para dar estilo al título -->
                        <th colspan="9">Ropas con bajo stock (necesitan reposicion)</th>
                ...
                <tbody>
                    <tr v-for="producto in arrayProductosBajo" :key="producto.id">
                        <td v-text="producto.id"></td>
                        <td v-text="producto.nombre_producto"></td>
                        <td v-text="producto.tipo_producto"></td>
                        
                        <td v-text="producto.cantidad" style="background-color: rgb(219, 75, 75); color: white;"></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
export default {
    ...
    methods: {
        ...
        listarInventario(page, buscar, criterio) {
            let me = this;
            var url = '/productos/productosBajoStock?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
            axios.get(url).then(function (response) {
                var respuesta = response.data;
                //console.log("lista almacen:",respuesta);
                me.arrayProductosBajo = respuesta.productosBajo.data;
